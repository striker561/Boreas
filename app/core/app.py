...
STARTUP_DEPENDENCY_RETRY_DELAY_SECONDS = (
    environment.STARTUP_DEPENDENCY_RETRY_DELAY_SECONDS
)


async def _warm_startup_dependencies(redis_cache: Any) -> None:
    ...
    for attempt in range(1, STARTUP_DEPENDENCY_MAX_ATTEMPTS + 1):
        try:
            ...
            if attempt == STARTUP_DEPENDENCY_MAX_ATTEMPTS:
                logger.error(
                    "Startup dependency warmup failed",
                    attempts=STARTUP_DEPENDENCY_MAX_ATTEMPTS,
